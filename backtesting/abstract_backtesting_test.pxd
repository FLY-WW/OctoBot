...
cdef class AbstractBacktestingTest:
    ...
    cpdef void _handle_results(self, object independent_backtesting, object profitability)
    cpdef void _register_only_strategy(self, object strategy_evaluator_class)
